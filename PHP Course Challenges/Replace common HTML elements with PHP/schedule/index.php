<?php $SITE_ROOT = "/challenge6" ?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>Roux Conference: Schedule</title>
<?php include "../common_php/head_metadata.php"; ?>
</head>
<body id="page_schedule">
<div class="wrapper">
  <?php include "../common_php/header.php"; ?>
  ...
  <aside id="sidebar">
    <article id="artistlist">
      ...
      <div class="pixgrid">
        <ul>
          <?php include "../common_php/featured_artists.php" ?>
        </ul>
        <p><a class="link" href="../artists.php">View Artist Info</a></p>
      </div>
    </article>
    <!-- Featured Artists -->
    <?php include "../common_php/mobile_site_aside.php"; ?>
    <!-- Coming to event --> 
  </aside>
  <!-- Sidebar -->
  <?php include "../common_php/footer.php"; ?>
</div>
